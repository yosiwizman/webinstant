      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <button
            ...
            className={`mt-4 inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-md text-white transition-colors ${
          ...
          >
            {testingEmail ? (
              ...
              <>
                <svg className="-ml-1 mr-2 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
